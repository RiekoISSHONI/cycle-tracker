...
export function SkinSection({ phaseData, phase }) {
  ...
  const phaseColors = {
    menstrual: { bg: 'from-rose-50 to-red-50', accent: 'text-rose-600', badge: 'bg-rose-100' },
    follicular: { bg: 'from-pink-50 to-purple-50', accent: 'text-pink-600', badge: 'bg-pink-100' },
    ovulatory: { bg: 'from-amber-50 to-orange-50', accent: 'text-amber-600', badge: 'bg-amber-100' },
    luteal: { bg: 'from-violet-50 to-purple-50', accent: 'text-violet-600', badge: 'bg-violet-100' }
  };
    ...
    <div className="card overflow-hidden">
      ...
      <div className={`p-4 bg-gradient-to-r ${colors.bg}`}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-800">{t('skin.title')}</h3>
